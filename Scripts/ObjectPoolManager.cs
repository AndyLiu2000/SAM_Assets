...
public class ObjectPoolManager<T1,T2> where T1:class, new()
{
    ...
    public ObjectPoolManager(int initialBufferSize, Action<T1, List<T2>, int,int> resetAction = null, Action<T1, List<T2>, int,int> initAction = null)
    {
