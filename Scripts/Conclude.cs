...
public class Conclude : MonoBehaviour {
    ...
    public GameObject Conclude_BackBtn;
    List<Loot_Sheet> loot = new List<Loot_Sheet>();

    private void Start()
    {
        UIEventListener.Get(Conclude_BackBtn).onClick = Conclude_BackBtn_Click;
    ...
    */
    public void Conclude_BackBtn_Click(GameObject b)
    {
        Debug.Log("BackBtn_Click");
        GameManager.instance.LoadScene(GameManager.instance.SCENCE_MAIN);
    }
}
